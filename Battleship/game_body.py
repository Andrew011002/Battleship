...
def game(saves = []):
    ...
    if saves:
        ...
        time.sleep(3)
        display(" Pick a number between 1 and 100. If you guess closer to my magic number you will go first\
    otherwise the AI will go. If there is a tie there will be a tie breaker. Remeber to pick wiseley.", style = "")
        SPACER
    ...
    while checkGrid(computerAI.grid) == checkGrid(playerOne.grid):
        ...
        display("ROUND RESULTS", center = True)
        time.sleep(1.5)
